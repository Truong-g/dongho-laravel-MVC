    ...
    <section class="content my-2">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
              <div class="col-md-7">
                <strong class="text-danger">Cập nhập bài viết</strong>
              </div>
        ...
        <div class="card-body">
            <section class = "content">
              <div class="row">
                <div class="col-md-9">
                    <div class="my-2">
                      <label for="title">Chủ đề bài viết</label>
                      <input type="text" value="{{old('title', $post->title)}}" id = "title" name = "title" class="form-control" placeholder="Nhập tên bài viết">
                    @if($errors->has('title'))
                    ...
                    <div class="my-2">
                      ...
                      <textarea name="content"  id="content" class="form-control" placeholder="Nhập chi tiết bài viết">{{old('content', $post->content)}}</textarea>
