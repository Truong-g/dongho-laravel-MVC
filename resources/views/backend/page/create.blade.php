    ...
    <section class="content my-2">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
              <div class="col-md-7">
                <strong class="text-danger">Thêm trang đơn</strong>
              </div>
              ...
              <div class="row">
                <div class="col-md-9">
                    <div class="my-2">
                      ...
                      <input type="text" value="{{old('title')}}" id = "title" name = "title" class="form-control" placeholder="Nhập tiêu đề trang đơn">
                    @if($errors->has('title'))
                    <span class="text-danger">{{ $errors->first('title') }}</span>
                    @endif
                    </div>
                    <div class="my-2">
                      <label for="content">Chi tiết trang đơn</label>
                      <textarea name="content" value="{{old('content')}}" id="content" class="form-control" placeholder="Nhập chi tiết trang đơn"></textarea>
