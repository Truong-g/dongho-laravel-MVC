          ...
          <table class="table table-striped table-bordered" id="myTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <a href="{{ route('slider.show',['slider' => $row -> id]) }}" class="btn btn-sm btn-success"><i class="fas fa-eye"></i></a>
                  <a href="{{ route('slider.edit',['slider' => $row -> id]) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>

                      @if($row->status == 1)
                  <a href="{{ route('slider.status',['id' => $row -> id]) }}" class="btn btn-sm btn-primary"><i class="fas fa-toggle-on"></i></a>
                      @else
                  <a href="{{ route('slider.status',['id' => $row -> id]) }}" class="btn btn-sm"><i class="fas fa-toggle-off"></i></a>
                      @endif
