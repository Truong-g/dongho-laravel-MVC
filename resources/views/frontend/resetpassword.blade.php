                    ...
                    <div class="form_container">
                      ...
                      <div class="row clearfix">
                        <div class="" style="width:100%">
                          <form style="width:100%" action="{{ route('site.resetpassword') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="input_field"> <span><i aria-hidden="true" class="fa fa-user"></i></span>
                                <input type="email" width="100%" name="email" value="{{$email}}" placeholder="Email" required />
                            </div>
                            <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                              <input type="password" width="100%" name="password" placeholder="Mật khẩu" required />
                            </div>
                            <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                                <input type="password" width="100%" name="repassword" placeholder="Nhập lại mật khẩu" required />
                              </div>
