        ...
        <div class="bread__crumb">
            <div class="grid wide">
                <ul>
                    ...
                    <li><strong class="currentBreadcrumb">Bài viết</strong></li>
                </ul>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col l-9">
                        <div class="post__container--left">
                            <div class="post__hotnews">
                                <a href="{{$single_post->slug}}" class="post__hotnews--img" style="background-image: url('{{asset('images/posts/'.$single_post->img)}}')">
                                    <div class="post__hotnews--text">
                                        <h3 class="post__hotnews--title">{{$single_post->title}}</h3>
                                        <p class="post__hotnews--time"><i class="far fa-clock"></i> 30/10/2021</p>
                                    </div>
                                </a>
                            </div>
