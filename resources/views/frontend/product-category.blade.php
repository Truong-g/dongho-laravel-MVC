        ...
        <div class="bread__crumb">
            <div class="grid wide">
                <ul>
                    ...
                    <li>
                        <a href="san-pham" class="bread__crumb--link">Sản phẩm</a>
                        <span class="arrowBreadcrumb"><i class="fa fa-angle-right"></i></span>
                    </li>
                    <li><strong class="currentBreadcrumb">{{$category->name}}</strong></li>
                </ul>
            </div>
        </div>
            ...
            <div class="grid wide">
                <div class="product__container-all">
                    <div class="row no-gutters">
                        ...
                        <div class="col l-9">
                            <div class="product__container--right">
                                <h2 class="product__container--right-title">{{$category->name}}</h2>
                                        ...
                                        <div class="row" style="flex-wrap: wrap;">
                                            ...
                                            <div class="col l-3" style="padding-left: 12px; padding-right: 12px; margin: 12px 0;">
                                                <div class="product__box">
                                                    <div class="product__image" style="background-image: url('{{asset('images/products/'.$product_cat->img)}}')">
                                                        @if ($product_cat->pricesale > 0)
                                                        <span class="product__set__sale">- {{sprintf( "%.0f", $product_cat->khuyenmai )}}%</span>
                                                        @endif
                                                    </div>
                                                    <div class="product__name">
                                                        <h4>{{$product_cat->productname}}</h4>
                                                    </div>
                                                    <div class="product__price">
                                                        <input type="hidden" value="{{$product_cat->pricesale > 0 ? $product_cat->pricesale : $product_cat->price}}" class="get__price-to-cart" />
                                                        <div class="product__priceBox">
                                                            <span class="newPrice">
                                                                @if ($product_cat->pricesale > 0)
                                                                    {{number_format($product_cat->pricesale, 0).'đ'}}
                                                                @else
                                                                    {{number_format($product_cat->price, 0).'đ'}}
                                                                @endif
                                                            </span>
                                                        </div>
                                                        @if ($product_cat->pricesale > 0)
                                                    ...
                                                    <div class="product__option">
                                                        <div class="option__view" onclick="location.href = '/{{$product_cat->productslug}}'">
                                                            <i class="fas fa-eye"></i>
                                                            <div class="handle__note">
                                                                <span>Xem chi tiết</span>
                                                            </div>
                                                        </div>
                                                        <div class="option__cart" onclick="addToCart({{$product_cat->productid}}, this.parentElement.parentElement)">
                    ...
                    <div class="pagination__container">
                        <span>{{ $list_product_cat->links('vendor.pagination.default')}}</span>
                    </div>
                </div>
            </div>
        </div>
